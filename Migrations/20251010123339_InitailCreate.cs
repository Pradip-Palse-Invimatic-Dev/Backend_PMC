        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurrentAddressId = table.Column<Guid>(type: "uuid", nullable: true),
                    PANCardNumber = table.Column<string>(type: "text", nullable: true),
                    AadharCardNumber = table.Column<string>(type: "text", nullable: true),
                    COACardNumber = table.Column<string>(type: "text", nullable: true),
                    ...
                    IsCertificateGenerated = table.Column<bool>(type: "boolean", nullable: false),
                    IsChallanGenerated = table.Column<bool>(type: "boolean", nullable: false),
                    RecommendedFormPath = table.Column<string>(type: "text", nullable: true),
                    CertificatePath = table.Column<string>(type: "text", nullable: true),
                    ChallanPath = table.Column<string>(type: "text", nullable: true),
                    IsDigitallySigned = table.Column<bool>(type: "boolean", nullable: false),
                    DigitalSignatureDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    SignedBy = table.Column<string>(type: "text", nullable: true),
                    CertificateNumber = table.Column<string>(type: "text", nullable: true),
                    CertificateGeneratedDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    CertificateGeneratedBy = table.Column<string>(type: "text", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CreatedBy = table.Column<string>(type: "text", nullable: true),
                    LastModifiedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    LastModifiedBy = table.Column<string>(type: "text", nullable: true)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Applications_Addresses_CurrentAddressId",
                        column: x => x.CurrentAddressId,
                        principalTable: "Addresses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Applications_Addresses_PermanentAddressId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastName = table.Column<string>(type: "text", nullable: false),
                    PhoneNumber = table.Column<string>(type: "text", nullable: true),
                    KeyLabel = table.Column<string>(type: "text", nullable: false),
                    DigitalSignaturePath = table.Column<string>(type: "text", nullable: true),
                    CurrentAddressId = table.Column<Guid>(type: "uuid", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CreatedBy = table.Column<string>(type: "text", nullable: true),
                    LastModifiedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Officers_Addresses_CurrentAddressId",
                        column: x => x.CurrentAddressId,
                        principalTable: "Addresses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Otp_Generated_At = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OtpVerifications_Applications_ApplicationId",
                        column: x => x.ApplicationId,
                        principalTable: "Applications",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EasebuzzOrderId = table.Column<string>(type: "text", nullable: false),
                    EasebuzzTransactionId = table.Column<string>(type: "text", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CreatedBy = table.Column<string>(type: "text", nullable: true),
                    LastModifiedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    LastModifiedBy = table.Column<string>(type: "text", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ScheduledByOfficerId = table.Column<Guid>(type: "uuid", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CreatedBy = table.Column<string>(type: "text", nullable: true),
                    LastModifiedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    LastModifiedBy = table.Column<string>(type: "text", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    ApplicationId = table.Column<Guid>(type: "uuid", nullable: false),
                    OfficerId = table.Column<Guid>(type: "uuid", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OfficerAssignments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OfficerAssignments_Applications_ApplicationId",
                        column: x => x.ApplicationId,
                        principalTable: "Applications",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OfficerAssignments_Officers_OfficerId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsVerified = table.Column<bool>(type: "boolean", nullable: false),
                    VerificationComments = table.Column<string>(type: "text", nullable: true),
                    VerifiedByOfficerId = table.Column<Guid>(type: "uuid", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CreatedBy = table.Column<string>(type: "text", nullable: true),
                    LastModifiedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    LastModifiedBy = table.Column<string>(type: "text", nullable: true)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Documents_Officers_VerifiedByOfficerId",
                        column: x => x.VerifiedByOfficerId,
                        principalTable: "Officers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Documents_Qualifications_QualificationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Applications_CurrentAddressId",
                table: "Applications",
                column: "CurrentAddressId");

            migrationBuilder.CreateIndex(
                name: "IX_Applications_PermanentAddressId",
                table: "Applications",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Documents_QualificationId",
                table: "Documents",
                column: "QualificationId");

            migrationBuilder.CreateIndex(
                name: "IX_Documents_VerifiedByOfficerId",
                table: "Documents",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OfficerAssignments_ApplicationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Officers_CurrentAddressId",
                table: "Officers",
                column: "CurrentAddressId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OtpVerifications_ApplicationId",
